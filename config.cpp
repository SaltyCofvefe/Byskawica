...
class CfgPatches
{
	...
	{
		units[]={};
		weapons[]={"Byskawica_F", "Byskawica_F"};
		requiredVersion=0.1;
...
class CfgWeapons
{
	...
	class Byskawica_Base_F: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
		magazines[] = {30Rnd_test_mag_Tracer, test_mag_group}; /// original custom made magazines and a group of several standardized mags
		reloadAction = "GestureReloadSMG_01"; /// MX hand animation actually fits this rifle well
...
//caseless ammo//
    ...
    ////////////////////////////////////////////////////// NO OPTICS ///////////////////////////////////////////////////////////
		...
		{
			begin1[] = { "Byskawica\sound\full.mp3", db0, 1, 500 };
	...
	class Byskawica_F: Byskawica_Base_F
	{
		scope = 2; /// should be visible and useable in game
		displayName = "Byskawica"; /// some name
		model = "\E:\Gun\Guns\Model2\Byskawica\Byskawica.p3d"; /// path to model
	...
	class Byskawica_holo_pointer_F: Byskawica_F /// standard issue variant with holo optics and laser pointer
	{
		class LinkedItems
		{
